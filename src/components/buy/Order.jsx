  ...
  return (
    <div className="w-full lg:w-1/2 p-6 lg:p-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">{showCheckout ? 'Checkout' : 'Order'}</h2>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${nameError ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-1 focus:outline-none focus:ring-orange-500 focus:border-orange-500 transition`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${phoneError ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-1 focus:outline-none focus:ring-orange-500 focus:border-orange-500 transition`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border ${addressError ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-1 focus:outline-none focus:ring-orange-500 focus:border-orange-500 transition`}
                />
