        ...
        {['all', 'unread'].map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 font-medium relative pb-1 transition ${isActive ? 'text-black border-b-2 border-black' : 'text-gray-600'
                }`}
            >
